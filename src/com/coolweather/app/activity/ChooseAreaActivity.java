...
public class ChooseAreaActivity extends Activity {
	...
	private boolean isFromWeatherAvtivity;//是否从WeatherActivity中跳转过来

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		
		super.onCreate(savedInstanceState);
		isFromWeatherAvtivity = getIntent().getBooleanExtra("from_weather_activity", false);
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
		//已经选择了城市且不是从WeatherActivity跳转过来，才会跳转到WeatherActivity
		
		if (prefs.getBoolean("city_selected", false)  && !isFromWeatherAvtivity) {
			Intent intent = new Intent(this,WeatherAvtivity.class);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (currentLevel == LEVEL_PROVINCE) {
					...
					Intent intent = new Intent(ChooseAreaActivity.this,WeatherAvtivity.class);
					startActivity(intent);
					finish();
				}
